...
public class EbooItemServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		System.out.println("Subindo servico ebook http://localhost:8082/webservices/ebook/item");
	}

	/*
	 * HTTP POST para: http://localhost:8081/webservices/ebook/item
	 */
	@Override
	...
	/*
	 * HTTP GET com os query params para http://localhost:8080/webservices/ebook/item
	 */
	@Override
